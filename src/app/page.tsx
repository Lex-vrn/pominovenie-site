    ...
    <div className="min-h-screen bg-gradient-to-b from-[#2C1810] to-[#1a0f0a] text-white">
      <div className="container mx-auto px-4 py-12 max-w-2xl">
        ...
        <div className="space-y-4 mb-8">
          <a href="/add" className="block w-full py-4 px-6 rounded-xl bg-[#8C2F2F] text-white font-medium text-lg text-center hover:bg-[#A63939] transition-colors shadow-lg">
            📅 Напоминания
          </a>
        ...
        <footer className="text-center mt-12">
          <a href="/about" className="text-[#D4AF37] hover:text-[#F4CF57] underline text-sm">
            О проекте
          </a>
        </footer>
      </div>
